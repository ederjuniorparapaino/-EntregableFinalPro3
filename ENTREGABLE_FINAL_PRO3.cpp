...
public:
	...
	void llenar() {
		string listaTitulo[] = {"Aprende python", "Programacion II", "Programacion III", "Aprende Linux", "Cien años de soledad", "Aprende Java", "Cien amargos años de un estudiante", "Gabriela", "anlan", "El principito"};
